                        ...
                        <div class="content-table" style="margin-top: 20px;">
                            ...
                            <tbody id="body">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{date('d-m-Y',strtotime($values->DepartureDay))}}</td>
                                        <td>{{number_format($values->Money,0)}} VNĐ</td>
                                        <td style='text-align: center';><a href="/webtravel/public/detailtouradmin/{{$values->IDTour}}"><img src='http://localhost/studentmanager/Image/edit.png'></a></td>
                                       <td><a href="/webtravel/public/deletetouradmin/{{$values->IDTour}}"><img src='http://localhost/studentmanager/Image/recycle.png' ></a></td>
                                    </tr>
                                 @endforeach
                            </tbody>
                            </table>
