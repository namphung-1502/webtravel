              ...
              <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
                ...
                <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                            ...
                            <div class="content-table" style="margin-top: 20px;">
                              <h3 style="color:#ccc">Khách hàng đã đăng ký tài khoản</h3>
                                    <table class="table">
                                    <thead>
                                    <tr>
                                        <th>ID</th>
                                ...
                                <h3 style="color:#ccc">Khách hàng đăng nhập qua FaceBook hay Google</h3>
                                <table class="table">
                                  <thead>
                                  <tr>
                                      <th>ID</th>
                              ...
                              <tbody id="body">
                                      @foreach($orthercustomer as $values2)
                                      <tr>
                                          <td>{{$values2->ID}}</td>
                                          <td>{{$values2->IDCustomer}}</td>
                                          <td>{{$values2->Name}}</td>
                                          <td>{{$values2->Email}}</td>
                                          <td>{{$values2->Avatar}}</td>
                                      </tr>
                                   @endforeach
                              </tbody>
                              </table>
