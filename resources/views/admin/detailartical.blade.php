            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
              ...
              <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
                ...
                <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                      ...
                      <p  align="center"><input type="submit" value="Lưu" class="btn btn-basic"><a href="{{route('totalarticaladmin')}}" style="color:black;text-decoration: none"><input type="button" value="Thoát" class="btn btn-basic" style="margin-left:5px;"></a></p>
                    </form>
                      </div>
