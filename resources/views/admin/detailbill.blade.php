              ...
              <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
                ...
                <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                            ...
                            <div class="content-table" style="margin-top:20px;">
                                <table class="table">
                                    ...
                                    <tbody id="body">
                                        ...
                                        @foreach($detail as $value)
                                         ...
                                         <?php $people += $value->Adult+$value->Young+$value->Baby; $money+=$value->TotalMoney?>
                                        @endforeach
                                        <tr>
                                ...
                                @if(strtotime(date('Y-m-d'))<strtotime($bill[0]['Day']))
                                <p style="color:#ccc;fons16px;">Trạng thái: <input type="text" style="color:black;padding:3px 5px 5px 7px;" value="{{$bill[0]['Status']}}" readonly> 
                                  <button class="btn btn-danger" style="font-size: 15px;padding:5px 10px 5px 10px;" id="delete" onclick="deletetour()">HỦY TOUR</button></td>
                                </p>
                                @else
                                <p style="color:#ccc;fons16px;">Trạng thái: <input type="text" style="color:black;padding:3px 5px 5px 7px;" value="Đã hoàn thành" readonly> 
                                </p>
                                @endif
...
<script>
  ...
  function deletetour()
  {
    ...
    event.preventDefault()
         $.ajax({
          url:'{{route('deletebilladmin')}}',
          type:'post',
          data: {id:{{$bill[0]['IDBill']}}},
          success:function(kq){
              console.log(kq);
          }
         })
         ...
         window.location="http://localhost/webtravel/public/totalbill";
  }
</script>
    <script>
