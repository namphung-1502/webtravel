            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
              ...
              <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
                ...
                <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                                ...
                                <table class="table">
                                    ...
                                    <tbody id="body">
                                           ...
                                           <tr>
                                            ...
                                            <td>{{$value->Email}}</td>
                                            <td>{{$value->Content}}</td>
                                            <td><button type="button" value="{{$value->Email}}" onclick="change(this.value)" data-toggle="modal" data-target="#myModal" style="background-color: inherit;border:none;outline:none"><img src="http://localhost/NKTravel/public/image/reply.png" alt=""></button></td>
                                        </tr>
                                        <?php $i++?>
                                           @endforeach
                                    </tbody>
                  ...
                  <div class="container">
                  <form method="post" action="{{url()->route('feedbackcustomer')}}">
                    {{ csrf_field() }}
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h3 class="modal-title" align="center"><b>Phản hồi khách hàng</b></h3>
                          </div>
                          <div class="modal-body" align="center">
                           <p><input type="text" name="email"  id="email" value="" placeholder="Email" style="padding:5px 10px 5px 10px;font-size: 16px;width: 100%" readonly></p>
                           <p><textarea  style="padding:10px;font-size: 16px;width: 100%" rows="10" name="content" id="content" value="" placeholder="Nội dung"></textarea></p>
                           <p><button class="btn btn-primary" data-dismiss="modal" style="margin-right:10px ">Thoát</button><button type="submit" class="btn btn-primary">Gửi</button></p>
                          </div>
                        </div>
                      </div>
                    </div>
