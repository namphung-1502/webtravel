                            ...
                            <table class="table">
                                ...
                                <tbody id="body">
                                  @foreach($bill as $value)
                                   ...
                                   <td><a href="http://localhost/webtravel/public/detailbilladmin/{{$value->IDBill}}"><img src="http://icons.iconarchive.com/icons/icons8/windows-8/32/Data-View-Details-icon.png" alt=""></a></td>
                                   </tr>
                                  @endforeach
                                </tbody>
                            </table>
