...
<body>
   ...
   <section id="contents">
    <nav class="navbar navbar-default">
      ...
      <div class="content1">
        <form action="{{url()->route('add')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(isset($error))
            ...
            <table>
                ...
                <tr>
                    <td>Hình ảnh:</td>
                    <td><img src="" style="width:100px;height:80px;margin-bottom:7px;" id="image">
                        <input type="file" name="image"  onchange="readURL(this)" required>
                    </td>
                </tr>
                <tr>
                    <td>Người viết:</td>
                    <td><input type="text" name="writer" id="id" value="" required ></td>
                </tr>           
                <tr>
                    <td>Mô tả: </td>
                <td><textarea name="des" id="" style="width:50%;height:150px;padding:7px;" placeholder="50-100 từ" required></textarea></td>
                </tr>
                <tr>
                    <td>Nội dung: </td>
                <td><textarea name="editor1" required></textarea></td>
                </tr>
            </table>
            <p  align="center"><a href="{{route('totalarticaladmin')}}" style="color:black;text-decoration: none"><input type="button" value="Thoát" class="btn btn-primary" style="margin-right:5px;"></a><input type="submit" value="Lưu" class="btn btn-primary"></p>
        </form>    
      </div>   
   </section>     
</body>
